...
from scripts.result_directory_processor import DirectoryProcessor
...
processor = DirectoryProcessor(
    ...
    xray_removal_param=[32, 22.9, 300],  # [chunk_size, sigma_threshold, beam_threshold]
...
#processor.process_in_sequence("analysis_001")

# Or process in parallel
processor.process_in_parallel(max_workers=8, analyze_no="analysis_parallel_test")
