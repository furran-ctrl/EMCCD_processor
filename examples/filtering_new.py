...
analyze_directory = r"C:\Users\ab177\Desktop\diffraction_results\1005night\analysis_parallel_time"
...
intensity_data = load_intensity_profiles(analyze_directory, std_check=True)
...
plot_waterfall_diffraction(
    ...
    filename=r"C:\Users\ab177\Desktop\waterfall_plot_output.png"
)